...
class CustomOrderTemplateService {
  ...
  async getById(templateId: number): Promise<CustomOrderTemplate> {
    return await apiService.getRequest<CustomOrderTemplate>(
  ...
  async getCategoriesWithTemplates(): Promise<CategoryWithTemplateCount[]> {
    return await apiService.getRequest<CategoryWithTemplateCount[]>(
      "/api/custom-order-templates/categories"
    );
  }
  ...
  async create(
    data: CreateCustomOrderTemplateRequest
  ): Promise<CustomOrderTemplate> {
    return await apiService.postRequest<CustomOrderTemplate>(
      "/api/custom-order-templates",
      data
    );
  }
  ...
  async update(
    templateId: number,
    data: UpdateCustomOrderTemplateRequest
  ): Promise<CustomOrderTemplate> {
    return await apiService.putRequest<CustomOrderTemplate>(
      `/api/custom-order-templates/${templateId}`,
      data
    );
  }
  ...
  async approve(templateId: number): Promise<CustomOrderTemplate> {
    return await apiService.postRequest<CustomOrderTemplate>(
      `/api/custom-order-templates/${templateId}/approve`
    );
  }
  ...
  async reject(
    ...
    return await apiService.postRequest<CustomOrderTemplate>(
      `/api/custom-order-templates/${templateId}/reject`,
      data
    );
  }

  async deactivate(templateId: number): Promise<CustomOrderTemplate> {
    return await apiService.postRequest<CustomOrderTemplate>(
      `/api/custom-order-templates/${templateId}/deactivate`
    );
  }

  async reactivate(templateId: number): Promise<CustomOrderTemplate> {
    return await apiService.postRequest<CustomOrderTemplate>(
      `/api/custom-order-templates/${templateId}/reactivate`
    );
  }
