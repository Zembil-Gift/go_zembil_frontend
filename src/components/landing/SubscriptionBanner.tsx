          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/95 backdrop-blur-md border border-white/20 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:scale-[1.02] overflow-hidden">
              ...
              <div className="p-8">
                ...
                <button className="w-full bg-gradient-to-r from-viridian-green to-june-bud hover:from-june-bud hover:to-viridian-green text-white font-bold py-4 px-6 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center justify-center space-x-2 group">
