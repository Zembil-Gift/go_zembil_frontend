...
export default function HeroSection({ searchTerm, onSearchChange }: HeroSectionProps) {
  ...
  return (
    <section className="relative bg-eagle-green text-white">
          ...
          <div className="mb-12 lg:mb-0">
            <FadeIn delay={0.2} duration={0.8}>
              <h1 className="font-gotham-extra-bold text-4xl sm:text-5xl lg:text-6xl leading-tight mb-6">
                ...
                <span className="text-white block">{t('homepage.hero.subtitle')}</span>
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.6} duration={0.8}>
              <div className="bg-white rounded-xl p-2 flex items-center shadow-xl max-w-md">
                ...
                />
                <Button className="bg-eagle-green hover:bg-eagle-green/90 text-white px-6 py-3 rounded-lg">
                  <Search size={16} />
                </Button>
              </div>
            </FadeIn>
            ...
            <div className="flex items-center space-x-8 mt-8 text-sm">
              <div className="flex items-center space-x-2">
                <Truck className="text-ethiopian-gold" size={16} />
                <span>{t('homepage.hero.freeDelivery')}</span>
              </div>
              <div className="flex items-center space-x-2">
                <Heart className="text-ethiopian-gold" size={16} />
