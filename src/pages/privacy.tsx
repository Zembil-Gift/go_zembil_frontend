          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <section className="mb-8">
              ...
              <p>
                ...
                agreements. Account information is retained while your account is active and 
            ...
            <section className="mb-8">
              ...
              <p>
                ...
                collect personal information from children under 13. If we discover that we 
                have collected such information, we will delete it promptly.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-charcoal mb-4">10. International Data Transfers</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-charcoal mb-4">11. Updates to This Policy</h2>
              <p>
