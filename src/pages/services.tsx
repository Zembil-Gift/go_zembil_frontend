          ...
          <FadeIn delay={0.1}>
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-june-bud/20 rounded-xl backdrop-blur-sm">
                <Calendar className="h-6 w-6 text-june-bud" />
              </div>
            ...
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-gotham-bold text-white mb-4 leading-tight">
              Book Amazing
              <span className="block text-june-bud">Services & Experiences</span>
            </h1>
            <p className="text-lg lg:text-xl font-gotham-light text-white/80 max-w-2xl leading-relaxed">
              Gift unforgettable experiences to your loved ones in Ethiopia.
              From photography to catering, find the perfect service for any occasion.
            </p>
          </FadeIn>
        </div>
