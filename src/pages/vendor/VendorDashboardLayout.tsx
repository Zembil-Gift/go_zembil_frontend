                  ...
                  {isVendorRejected ? (
                    <>
                      <p className="mt-1 text-sm text-red-700">
                        Please update your business details and resubmit your
                        application from Settings.
                      </p>
                    ...
                    <>
                      <p className="mt-1 text-sm text-amber-700">
                        Thank you for registering as a vendor! Your account is
                        currently being reviewed by our team. Once approved,
                        you'll be able to create products, events, services, and
