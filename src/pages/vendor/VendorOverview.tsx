...
import type { CustomOrderTemplate, PagedCustomOrderTemplateResponse } from "@/types/customOrders";
...
export default function VendorOverview() {
  ...
  const serviceOrders: ServiceOrderResponse[] = serviceOrdersData?.content || [];
  ...
  const serviceOrderStats = {
    pending: serviceOrders.filter((o) => o.status === 'BOOKED' && o.paymentStatus === 'PAID').length,
    confirmed: serviceOrders.filter((o) => o.status === 'CONFIRMED_BY_VENDOR').length,
