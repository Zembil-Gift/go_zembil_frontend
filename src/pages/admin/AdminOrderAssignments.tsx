...
export default function AdminOrderAssignments() {
  ...
  const { data: assignmentsData, isLoading: loadingAssignments } = useQuery({
    ...
    queryFn: () =>
      adminDeliveryService.getAllAssignments({
  ...
  const assignMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: "Success",
        description: "Order assigned to delivery person",
      });
      queryClient.invalidateQueries({
        queryKey: ["admin", "delivery-assignments"],
      });
      queryClient.invalidateQueries({
        queryKey: ["admin", "orders-ready-for-delivery"],
      });
  ...
  const unassignedOrders: OrderReadyForDeliveryDto[] =
    ordersData?.content || [];
                      ...
                      {assignment.deliveryFee ? (
                        <div>
                          <span className="font-semibold text-green-700">
                            {assignment.deliveryFeeCurrency === "ETB"
                              ? "ETB "
                              : "$"}
      ...
      <Dialog open={showAssignDialog} onOpenChange={setShowAssignDialog}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              {selectedOrderId && (
                <div className="mt-2 p-2 bg-gray-50 rounded text-sm">
                  {(() => {
                    const order = unassignedOrders.find(
                    ...
                    return order ? (
                      <>
                        ...
                        <p>
                          ...
                          {order.shippingAddress || "N/A"}, {order.shippingCity}
                        </p>
                      </>
                    ) : null;
                  })()}
            ...
            <div>
              <Label htmlFor="order-assignment-eta">ETA *</Label>
              <Input
                id="order-assignment-eta"
                type="datetime-local"
                value={selectedEta}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="font-medium">
                    ...
                    {selectedAssignment.shippingCity &&
                      `, ${selectedAssignment.shippingCity}`}
                  </p>
                </div>
              </div>
                ...
                {selectedAssignment.deliveryFee && (
                  <div className="flex justify-between items-center border-t pt-2">
                    ...
                    <span className="text-lg font-bold text-green-700">
                      {selectedAssignment.deliveryFeeCurrency === "ETB"
                        ? "ETB "
                        : "$"}
              ...
              {selectedAssignment.pickupImageUrl && (
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Photo taken when the delivery person picked up the package
                    from the vendor
                  </p>
              ...
              {selectedAssignment.proofImageUrl && (
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Photo taken when the package was delivered to the customer
                  </p>
                  <div className="border rounded-lg overflow-hidden">
                    <img
