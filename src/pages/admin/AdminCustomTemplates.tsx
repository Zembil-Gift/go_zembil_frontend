...
export default function AdminCustomTemplates() {
  ...
  const [selectedTemplate, setSelectedTemplate] =
    useState<CustomOrderTemplate | null>(null);
  ...
  const { data: pendingData, isLoading } = useQuery({
    queryKey: ["admin", "pending-custom-templates", filters],
    queryFn: () =>
      customOrderTemplateService.getPending(
        filters.page,
        filters.size,
        filters.sort
      ),
  ...
  const { data: allData, isLoading: allLoading } = useQuery({
    queryKey: ["admin", "all-custom-templates", filters],
    queryFn: () =>
      customOrderTemplateService.getAll(
        filters.page,
        filters.size,
        undefined,
        filters.sort
  ...
  const approveMutation = useMutation({
    mutationFn: (templateId: number) =>
      customOrderTemplateService.approve(templateId),
    onSuccess: () => {
  ...
  return (
    ...
    >
      <FilterBar
        apiEndpoint="/api/custom-order-templates/all"
      ...
      >
        <TabsList className="flex flex-wrap gap-1 w-full h-auto p-1">
          <TabsTrigger
            value="pending"
            className="flex items-center gap-2 whitespace-normal text-xs sm:text-sm text-center px-2 sm:px-4"
          >
        ...
        <TabsContent value="pending">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review and approve or reject pending templates
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            <Button
                              size="sm"
                              onClick={() =>
                                approveMutation.mutate(template.id)
                              }
        ...
        <TabsContent value="all">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View all custom order templates in the system
              </CardDescription>
            </CardHeader>
            <CardContent>
              {allLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    No custom order templates have been created yet
                  </p>
                </div>
              ) : (
                <Table>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedTemplate.categoryName || "Uncategorized"}
                    </p>
                  </div>
                </div>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">
                            Type:{" "}
                            {customOrderTemplateService.getFieldTypeDisplayName(
                              field.fieldType
                            )}
                          </p>
                          {field.description && (
